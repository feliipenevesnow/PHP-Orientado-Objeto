        ...
        <div class="container">
            <div class="row justify-content-center mt-5">
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <form class="row g-3" action="depositar.php?conta=1&agencia=<?php echo $conta->getAgencia(); ?>&numero=<?php echo $conta->getNumero(); ?>" method="POST">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <label for="valor" class="form-label">Valor de Depósito</label>
